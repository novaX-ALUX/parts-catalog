...
PINOUT_NOTES_KO = {
    "AF-H7E-Lite": "잠정 핀 정의입니다 — AF-H7E Lite 는 개발 중이라 출시 전에 커넥터가 바뀔 수 있습니다. 모든 JST 커넥터는 Pixhawk 표준처럼 1번 핀이 전원, 마지막 핀이 GND 입니다. "
                   ...
                   "POWER 1 · 2 는 맨 뒤 윗면이고 잠금이 뒷벽을 향해 있어 위에서 눌러 뽑습니다. RC IN · UART 4 · 6 은 그 아랫면에서 뒤로 꽂습니다. PWM 헤더는 센서 모듈 2.3 mm 뒤이며 신호 줄(S)이 가장 뒤라, 빗살 홈 때문에 서보 플러그는 S 가 뒤로 가야 꽂힙니다. "
