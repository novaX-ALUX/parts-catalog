...
firmware:
  - kind: "ArduPilot (.apj package)"
    file: https://github.com/novaX-ALUX/fc-boards/releases/download/AF-H7_nano-v1.2.3/AF-H7_nano-v1.2.3.apj
    version: "1.2.3"
    date: "2026-07-11"
    size: "1.3 MB"
  ...
  - kind: "Bootloader + App (merged HEX · DFU / SWD)"
    file: https://github.com/novaX-ALUX/fc-boards/releases/download/AF-H7_nano-v1.2.3/AF-H7_nano-v1.2.3_with_bl.hex
    version: "1.2.3"
    date: "2026-07-11"
    size: "5.2 MB"
...
firmwareNotes: |
  Supports Betaflight, INAV, and ArduPilot out of the box. Recommended targets: Betaflight MATEKH743 / ArduPilot MatekH743. Enter USB-C DFU bootloader by holding the BOOT button during power-up. All firmware releases are published on GitHub: https://github.com/novaX-ALUX/fc-boards/releases
---
