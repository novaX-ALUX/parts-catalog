...
specs:
  ...
  - key: Satellite Systems
    value: BDS / GPS / GLONASS / Galileo / QZSS
  - key: Antenna Band
    value: L1 Band Only
  - key: Antenna Type
    value: Built-in Ceramic Patch
  - key: Single-Point Accuracy
    value: H 1.5 m / V 2.5 m (RMS)
  - key: Cold Start
    value: < 27 sec
  - key: Hot Start
    value: < 1 sec
  - key: Update Rate
    value: 1 – 18 Hz (Default 10 Hz)
  - key: Data Format
    value: NMEA / UBX
  - key: Comm. Protocol
    value: UART (TTL)
